...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxRuntimeLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at androidx.runtime.saved
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class AndroidxRuntimeSavedLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Returns the group of libraries at androidx.runtime.saved.instance
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class AndroidxRuntimeSavedInstanceLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxRuntimeSavedInstanceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for state (androidx.compose.runtime:runtime-saved-instance-state)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
        ...
        public PlayServicesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for places (com.google.android.gms:play-services-places)
             * This dependency was declared in catalog libs.versions.toml
         * @deprecated Will be removed in Gradle 9.0.
             */
        @Deprecated
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: playServicesPlaces (17.1.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: runtimeSavedInstanceState (1.0.0-alpha11)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            ...
            /**
             * Returns the version associated to this alias: uiGraphicsAndroid (1.6.8)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
